      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {readyDeliveries.length === 0 ? (
          ...
          readyDeliveries.map((delivery) => (
            <div key={delivery.id} className="bg-white border border-green-100 p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-200">
              <div className="mb-4">
                ...
                <div className="text-sm">
                  ...
                  <p className="font-medium text-green-700">🎿 Deliver: {formatDisplayDate(delivery.orderDate)}</p>
