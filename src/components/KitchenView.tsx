      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {pendingTickets.length === 0 ? (
          ...
          pendingTickets.map((ticket) => (
            <div key={ticket.id} className="bg-white border border-blue-100 p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-200">
              <div className="mb-4">
                ...
                <div className="text-sm text-gray-600">
                  ...
                  <p className="font-medium text-blue-700">🎿 {formatDisplayDate(ticket.orderDate)}</p>
